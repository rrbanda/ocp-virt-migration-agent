...
Read `references/common-mtv-failures.md` for known issues (updated for MTV 2.8 – 2.11).

Common failure categories:
- **Network**: VDDK connection failures, SSL certificate issues, vSAN VDDK requirement
- **Storage**: Insufficient space, PV provisioning failures, storage copy offload errors (MTV 2.11)
- **Conversion**: virt-v2v errors, driver issues
- **Warm Migration**: CBT snapshot limit (32 max), CBT not enabled, hibernated VM, NFC memory exhaustion

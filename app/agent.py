...
def _build_workflow():
    ...
    dispatcher = LlmAgent(
        ...
        instruction=(
            ...
            "## How to respond\n"
            "For most queries (list VMs, check status, analyze output, assess risk, "
            "plan batches, read logs), use your tools and skills directly and give "
            "the user a complete answer.\n\n"
            ...
            "- cluster-preflight, vmware-feature-mapper, network-architect, storage-advisor\n"
            "- pre-migration-analyzer, ansible-output-parser, assessment-report-generator\n"
            "- post-migration-validator, completion-report-generator, mtv-log-analyzer\n"
            "- day2-operations, production-migration-planner\n"
